...
export function SeriesRecommendationsPage() {
  const { data: watchlist } = useWatchlist('series');
      ...
      <div className="mb-8">
        ...
        <div className="mt-3 flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 text-primary font-medium">
            ...
            7.5+ TMDB ratings only
          </span>
        </div>
      </div>

      <ContentSectionNav basePath="series" watchlistCount={watchlist?.length} />
